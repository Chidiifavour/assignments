...
first=Bank(bank)
print(first.create_account("3254","Favour"))
print(first.create_account("3264","John"))
print(first.deposit_money("3254",1200000))
print(first.withdraw_money("3264",200000))
print(first.transfer_money("3254","3264",700000))
print(first.check_balance("3264"))
print(first.list_all_accounts())
#print(first.bank)